...
import reto5ciclo2.controller.ReportesController;
import reto5ciclo2.model.vo.*;
...
public class ReportesView extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == i3) {
            ...
            lblConsulta.setText("Consultas Compras Homecenter Salento");
        }
    }
}